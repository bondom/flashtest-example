  ...
  render() {
    ...
    return (
      <form className="registrationForm" onSubmit={this.onSubmit}>
        Registration Form
        {this.state.message && (
          <span className="message" data-hook="registration-form__response-msg">
            {this.state.message}
          </span>
        )}
        ...
        <input
          ...
          className={
            validator.isFieldValid(this.state, "login") ? "validInput" : ""
          }
        />
        {errors.login && (
          <span
            className="registrationFormError"
            data-hook="registration-form__login-error"
          >
            {errors.login}
          </span>
        )}
        ...
        <input
          ...
          onChange={this.onChange}
          className={
            validator.isFieldValid(this.state, "password") ? "validInput" : ""
          }
        />
        {errors.password && (
          <span
        ...
        <select
          ...
          name="sex"
          className={
            validator.isFieldValid(this.state, "sex") ? "validInput" : ""
          }
        >
        ...
        {errors.sex && (
          <span
            className="registrationFormError"
            data-hook="registration-form__sex-error"
          >
            {errors.sex}
          </span>
        )}
        ...
        <input
          ...
          className={
            validator.isFieldValid(this.state, "age") ? "validInput" : ""
          }
        ...
        {errors.age && (
          <span
            className="registrationFormError"
            data-hook="registration-form__age-error"
          >
            {errors.age}
          </span>
        )}
        ...
        <div
          className={
            validator.isFieldValid(this.state, "privacyPolicy")
              ? "validInput"
              : ""
          }
        ...
        <button
          ...
          type="submit"
          className={validator.isFormValid(this.state) ? "btnValid" : ""}
        >
          Sign Up
        </button>
      </form>
