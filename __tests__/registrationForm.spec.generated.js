...
describe("RegistrationForm", () => {
  ...
  beforeAll(async () => {
    ...
    await page.goto("http://localhost:8002/registrationForm");
  }, timeout);
  ...
  it(
    ...
    async () => {
      ...
      expect(
        await page.$('[data-hook="registration-form__password-error"]')
      ).toEqual(null);
      expect(
        await page.$eval(
          '[data-hook="registration-form__password"]',
      ...
      expect(
        await page.$eval('[data-hook="registration-form__age"]', el => el.value)
      ).toEqual("");
      expect(
        await page.$eval(
      ...
      expect(
        await page.$eval(
          '[data-hook="registration-form__response-msg"]',
          el => el.outerHTML
        )
      ).toEqual(
        '<span class="message" data-hook="registration-form__response-msg">Success login</span>'
      );
    },
    timeout
  );
